      ...
      <div className="mx-auto max-w-4xl px-6 text-center">
        <Reveal>
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-navy-700 to-navy-600 px-8 py-16 shadow-card sm:px-16">
            ...
            <p className="relative mx-auto mt-5 max-w-xl text-sm leading-relaxed text-navy-50 sm:text-base">
              {content.description}
            </p>
            <div className="relative mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
              ...
              <a
                ...
                className="inline-flex w-full items-center justify-center whitespace-nowrap rounded-full border border-white/40 px-8 py-4 text-sm font-bold text-white transition hover:-translate-y-0.5 hover:border-white focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-navy-700 sm:w-auto sm:text-base"
              >
                {content.label}
              </a>
            </div>
